...
def record_audio(duration, audio_path):
    """
    Record audio from the microphone and save it as a WAV file. The user has the possibility to stop  the recording
    earlier by pressing Enter on the keyboard.
